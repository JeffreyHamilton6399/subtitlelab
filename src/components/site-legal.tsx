...
function PrivacyBody() {
  return (
    <>
      <p>
        Your privacy is the whole point of SubtitleLab. This page explains exactly
        what happens when you use it.
      </p>

      <h3>We don’t see your media files. Ever.</h3>
      <p>Media decoding and speech recognition run locally on your device via WebAssembly. The transcription model is downloaded to your browser and runs there — your audio and video are never uploaded.</p>
      ...
      <p>
        SubtitleLab does not require sign-up and does not use accounts. It sets no
      ...
      <p>
        ...
        disk by SubtitleLab itself beyond what you explicitly save.
      </p>

      <h3>Analytics</h3>
      <p>
        SubtitleLab includes no third-party analytics and no advertising trackers.
      ...
      <p>
        SubtitleLab is a general-purpose utility and does not knowingly collect
      ...
      <h3>Contact</h3>
      <p>
        SubtitleLab is open source. For questions about this policy, email{" "}
        <a
...
function TermsBody() {
  return (
    <>
      <p>
        By using SubtitleLab, you agree to these terms. They’re short on purpose.
      </p>

      <h3>The service</h3>
      <p>
        SubtitleLab is a free, browser-based tool for extracting, creating, and fixing subtitles. It is provided “as is” and “as available”,
      ...
      <ul>
        <li>Don’t use SubtitleLab for anything you don’t have the right to do.</li>
      ...
      <h3>Free and open</h3>
      <p>
        SubtitleLab is free to use. There are no paid tiers, no watermarks, and no
      ...
      <p>SubtitleLab is built on open-source libraries, including ffmpeg.wasm, and Transformers.js. Each is governed by its own license.</p>

      <h3>Changes</h3>
      <p>
        These terms may be updated from time to time. Continued use of
        SubtitleLab after a change constitutes acceptance of the updated terms.
      </p>
    </>
  );
}
